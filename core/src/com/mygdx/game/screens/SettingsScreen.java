...
public class SettingsScreen extends ScreenAdapter {
    ...
    public SettingsScreen(MyGdxGame myGdxGame) {
        ...
        titleTextView = new TextView(myGdxGame.largeWhiteFont, 500, 660, "Settings");
        blackoutImageView = new ImageView(370, 160, GameResources.BLACKOUT_MIDDLE_IMG_PATH);
        clearSettingView = new TextView(myGdxGame.commonWhiteFont, 420, 360, "clear records");
